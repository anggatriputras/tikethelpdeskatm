...
class Workstations_mod extends CI_Model {

    function workstations_mod()
    {
        parent::__construct();
    }
    ...
    function get_workstations($rows=false,$where=null,$limit=false,$skip=0,$take=10)
    {
        ...
        // $this->db->where_in('is_workstations', 1);
