tinymce.PluginManager.add("image", function(e) {
    ...
    function t() {
        ...
        function n(e) {
            var t, n, r, i;
            n = a.find("#padding_top")[0],
			n = a.find("#padding_right")[0],
			n = a.find("#padding_bottom")[0],
			n = a.find("#padding_left")[0],
        ...
        function r() {
            ...
            var n = a.toJSON();
            "" === n.width && (n.width = null), "" === n.height && (n.height = null), "" === n.padding_top && (n.padding_top = 0), "" === n.padding_right && (n.padding_right = 0), "" === n.padding_bottom && (n.padding_bottom = 0), "" === n.padding_left && (n.padding_left = 0), "" === n.style && (n.style = null), n = {
                src: n.src,
                alt: n.alt,
                width: n.width,
                height: n.height,
                style: "padding:"+n.padding_top+"px"+" "+n.padding_right+"px"+" "+n.padding_bottom+"px"+" "+n.padding_left+"px;"
