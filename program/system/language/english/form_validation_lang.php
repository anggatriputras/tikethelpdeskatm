...
$lang['valid_email']		= "%s harus mengandung alamat email yang valid.";
$lang['valid_emails']		= "%s harus mengandung alamat email yang valid.";
$lang['valid_url']			= "%s harus mengandung URL yang valid.";
$lang['valid_ip']			= "%s harus mengandung IP yang valid.";
$lang['min_length']			= "%s harus mengandung minimal %s karakter.";
$lang['max_length']			= "%s harus tidak melebihi %s karakter.";
...
$lang['numeric']			= "%s harus mengandung nomor.";
$lang['is_numeric']			= "%s harus mengandung karakter nomor.";
$lang['integer']			= "%s harus mempunyai format integer.";
$lang['regex_match']		= "%s tidak mempunyai format yang valid.";
$lang['matches']			= "%s tidak sama dengan field %s.";
